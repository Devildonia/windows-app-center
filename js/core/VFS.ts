        ...
        children: {
            ...
            'DOCUMENTS': {
                name: 'DOCUMENTS', type: 'dir', children: {
                    'README.txt': { name: 'README.txt', type: 'file', content: 'Welcome to Windows App Center v1.6.4' }
                }
            },
            'GAMES': {
                name: 'GAMES',
            ...
            try {
                ...
                if (root && root.children && !needsReset) {
                    ...
                    if (docs && docs.children && docs.children['README.txt']) {
                        docs.children['README.txt'].content = 'Welcome to Windows App Center v1.6.4';
                    }
