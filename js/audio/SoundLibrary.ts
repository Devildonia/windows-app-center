...
export const DEFAULT_SOUNDS: Record<string, ISoundConfig> = {
    ...
    fall_impact: { type: 'noise', frequency: 100, duration: 0.2, volume: 0.2, lowpass: 200 },
    ...
    clap: { type: 'noise', frequency: 2000, duration: 0.08, volume: 0.12, lowpass: 3000 },
    ...
    step: { type: 'noise', frequency: 100, duration: 0.03, volume: 0.05, lowpass: 300 },
    sit: { type: 'noise', frequency: 150, duration: 0.3, volume: 0.1, lowpass: 500 },
    ...
    whoosh: { type: 'noise', frequency: 500, duration: 0.4, volume: 0.15, lowpass: 1000 },
    ...
    bonk: { type: 'noise', frequency: 150, duration: 0.15, volume: 0.25, lowpass: 300 },
    ...
    gasp: { type: 'noise', frequency: 400, duration: 0.2, volume: 0.12, lowpass: 600 },
};
